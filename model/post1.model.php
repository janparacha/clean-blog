<?php 
    ...
    $color = 'green';
    $content = "Comprendre la culture glisse actuelle nécessite de connaître son ancrage et sa caractéristique de contre-culture. Le phénomène culturel «glisse» prend sa source en Californie à la fin des années 50, avec les surfeurs pour lesquels le surf est un véritable mode de vie lié à des conduites alternatives issues d'un profond rejet de la société de consommation. Le surf way of life s'oppose alors à l'american <span class='test'> way of life. </span>
